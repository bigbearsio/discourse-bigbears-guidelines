...
<img src="https://upload.wikimedia.org/wikipedia/commons/a/a3/Graham%27s_Hierarchy_of_Disagreement-en.svg" width="80%"/>

*   พูดจาดูถูกเหยียดหยามผู้อื่น (Name calling) เช่น อีโง่ อีควาย พ่อแม่ไม่สั่งสอน
*   โจมตีบุคคล โดยไม่โต้แย้งข้อมูลของอีกฝ่าย (Ad hominem attacks) เช่น คนนี้มันเก่งไม่เท่าผมหรอก อย่าไปสนใจเด็กกระจอกๆเลย
*   วิจารณ์โทนเสียงหรือการนำเสนอ แทนที่จะโต้แย้งประเด็นของอีกฝ่าย (Responding to tone) เช่น มันเป็นคนที่ชอบพูดจาอวดเก่ง ที่มันพูดมันก็โม้ๆทั้งนั้นแหละ
*   ยกตัวอย่างแย้ง โดยไม่มีหลักฐานสนับสนุน (Knee-jerk contradiction) เช่น บอกว่าสิ่งๆนี้ไม่จะเป็นไม่ต้้องไปใช้มัน ให้ลบทิ้งไป โดยไม่บอกสาเหตุว่าทำไมจึงลบมันทิ้งไป และมีผลต่อระบบหรือไม่
