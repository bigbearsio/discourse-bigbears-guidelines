...
## [ถ้าคุณเจอปัญหา โปรดปักธง](#flag-problems)

ผู้ดูแลจะมีอำนาจพิเศษ เขาจะมีความรับผิดชอบต่อฟอรั่มนี้ แต่เช่นเดียวกับคุณเหมือนกัน ด้วยความช่วยเหลือจากคุณ. ผู้ดูแลสามารถเป็นผู้อำนวยความสะดวกให้กับฟอรั่ม ไม่ใช่เป็นแค่เพียงตำรวจหรือภารโรง.

เมื่อคุณพบเจอกับพฤติกรรมที่แย่ โปรดอย่าตอบกลับ มันเป็นการกระตุ้นให้เกิดการทำพฤติกรรมแย่ๆโดยที่มีการยอมรับมัน ผลานทั้งพลังงานและเวลาของทุกคน _แค่เพียงคุณปักธง_ ถ้าหากมีคนปักธงพอสมควร จะมีการดำเนินงาน ทั้งอัตโนมัติและผู้ดูแล.

ตามลำดับเพื่อการบำรุงรักษาชุมชนของเรา ผู้ดูแลขอสงวนสิทธิ์ที่จะลบคอนเท้นต์และผู้ใช้ต่างๆสำหรับเหตุผลต่างๆได้ตลอดเวลา ผู้ดูแลไม่ได้ดูตัวอย่างโพสต์ใหม่ ผู้ดูแลและผู้ให้บริการเว็บไซต์จะไม่รับผิดชอบต่อเนื้อหาใด ๆ ที่โพสต์โดยชุมชน.
